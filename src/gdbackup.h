...
template <> struct matjson::Serialize<gdbackupFile> {
    ...
    static matjson::Value to_json(const gdbackupFile& file) {
      return matjson::Object{
          {"backupName", file.backupName}, {"CCGameManager", file.CCGameManager}, {"CCGameManager2", file.CCGameManager2}, {"CCLocalLevels", file.CCLocalLevels}, {"CCLocalLevels2", file.CCLocalLevels2},
      };
    }
};
